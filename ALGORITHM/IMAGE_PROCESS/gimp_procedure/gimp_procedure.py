...
def gimp_procedure(data_file,processed_file,save_dir,medblur_radius,save,play_through,signature,verbosity):
        sleeptime = 1
        ...
        diff.set_property("radius1",8)
        diff.set_property("radius2",4)
        write = graph.create_child("gegl:write-buffer")
        write.set_property("buffer", shadow)
        src.link(diff)
        diff.link(write)
        ...
        config.set_property('noise-1', std_dev_masked*1.75)
        ...
        config.set_property('layer', background)
        result = procedure.run(config)
        background_copy = result.index(1)

        procedure = Gimp.get_pdb().lookup_procedure('gimp-image-insert-layer')
        config = procedure.create_config()
        config.set_property('image', image)
        config.set_property('layer', background_copy)
        config.set_property('parent', None)
        ...
        procedure = Gimp.get_pdb().lookup_procedure('gimp-item-set-name')
        config = procedure.create_config()
        config.set_property('item', background_copy)
        config.set_property('name', 'background_copy')
        result = procedure.run(config)
        ...
        config = procedure.create_config()
        config.set_property('image', image)
        config.set_property('merge-layer', original_masked)
        config.set_property('merge-type', 0)
        result = procedure.run(config)
        original_masked_filled = result.index(1)

        procedure = Gimp.get_pdb().lookup_procedure('gimp-item-set-name')
        config = procedure.create_config()
        config.set_property('item', original_masked_filled)
        config.set_property('name', 'original_masked_filled')
        result = procedure.run(config)
        ...
        procedure = Gimp.get_pdb().lookup_procedure('gimp-layer-copy')
        config = procedure.create_config()
        config.set_property('layer', original_masked_filled)
        result = procedure.run(config)
        omf_hp = result.index(1)

        procedure = Gimp.get_pdb().lookup_procedure('gimp-image-insert-layer')
        config = procedure.create_config()
        config.set_property('image', image)
        config.set_property('layer', omf_hp)
        config.set_property('parent', None)
        config.set_property('position', 0)
        result = procedure.run(config)
        ...
        procedure = Gimp.get_pdb().lookup_procedure('gimp-item-set-name')
        config = procedure.create_config()
        config.set_property('item', omf_hp)
        config.set_property('name', 'second_highpass')
        result = procedure.run(config)

        Gegl.init()

        buffer = omf_hp.get_buffer()
        shadow = omf_hp.get_shadow_buffer()
        graph = Gegl.Node()
        src = graph.create_child("gegl:buffer-source")
        src.set_property("buffer", buffer)
        gauss = graph.create_child("gegl:gaussian-blur")
        ...
        write.process()
        shadow.flush()
        omf_hp.merge_shadow(True)
        omf_hp.update(0,0,omf_hp.get_width(),omf_hp.get_height())
        ...
        procedure = Gimp.get_pdb().lookup_procedure('gimp-drawable-histogram')
        config = procedure.create_config()
        config.set_property('drawable', omf_hp)
        config.set_property('channel', 0)
        config.set_property('start-range', 0)
        config.set_property('end-range', 1)
        result = procedure.run(config)
        ...
        omf_hp_thresh = mean + std_dev*3
        procedure = Gimp.get_pdb().lookup_procedure('gimp-drawable-threshold')
        config = procedure.create_config()
        config.set_property('drawable', omf_hp)
        config.set_property('channel', 0)
        config.set_property('low-threshold', omf_hp_thresh)
        config.set_property('high-threshold', 1)
        result = procedure.run(config)
        ...
        config.set_property('mask-type', 5)
        result = procedure.run(config)
        omf_hp_mask = result.index(1)

        procedure = Gimp.get_pdb().lookup_procedure('gimp-layer-add-mask')
        config = procedure.create_config()
        config.set_property('layer', omf_hp)
        config.set_property('mask', omf_hp_mask)
        result = procedure.run(config)
        ...
        config.set_property('image', image)
        config.set_property('operation', 2)
        config.set_property('item', omf_hp_mask)
        result = procedure.run(config)
        ...
        procedure = Gimp.get_pdb().lookup_procedure('gimp-drawable-edit-clear')
        config = procedure.create_config()
        config.set_property('drawable', original_masked_filled)
        result = procedure.run(config)
        ...
        config = procedure.create_config()
        config.set_property('image', image)
        config.set_property('merge-layer', original_masked_filled)
        config.set_property('merge-type', 0)
        result = procedure.run(config)
        original_masked_filled_complete = result.index(1)

        procedure = Gimp.get_pdb().lookup_procedure('gimp-item-set-name')
        config = procedure.create_config()
        config.set_property('item', original_masked_filled_complete)
        config.set_property('name', 'original_masked_filled_complete')
        result = procedure.run(config)
        ...
        procedure = Gimp.get_pdb().lookup_procedure('gimp-layer-copy')
        config = procedure.create_config()
        config.set_property('layer', original_masked_filled_complete)
        result = procedure.run(config)
        ...
        config.set_property('channel', 0)
        config.set_property('low-input', median_masked-std_dev_masked)
        config.set_property('high-input', median_masked+2*std_dev_masked)
        config.set_property('clamp-input', False)
        config.set_property('gamma', 1)
        config.set_property('low-output', 0)
        config.set_property('high-output', 1)
        ...
        config.set_property('channel', 0)
        config.set_property('low-input', median-3*std_dev)
        config.set_property('high-input', median+3*std_dev)
        config.set_property('clamp-input', False)
        config.set_property('gamma', 1)
        config.set_property('low-output', 0)
        config.set_property('high-output', 1)
