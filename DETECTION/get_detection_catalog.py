...
if __name__ == '__main__':
    ...
    from DETECTION.detection.bin_image import bin_image
    from DETECTION.detection.mask_image import mask_image
    from DETECTION.detection.filter_table import filter_table